...
const AdminLender = () => {
  ...
  const customers: customerType[] = useAppSelector(
    (state) => state.customer.values
  );
  ...
  const columns: ColumnsType<ColumnsType> = [
    ...
    },
    {
      ...
      render: (values, record, index) => (
        <div>
          {values.status ? (
            <div style={{ color: "#61bd4f" }}>Đang hoạt động</div>
          ) : (
            <div style={{ color: "red" }}>Khóa</div>
          )}
        </div>
      ),
    },
        ...
        return (
          <Space size="middle">
            ...
            <button
              ...
              onClick={() => handlerRemoveCustumer(item._id)}
            >
              <AiFillDelete />
            </button>
          </Space>
  ...
  return (
    <div>
      ...
      <h1 className="text-[25px]">
        Danh sách khách hàng ({customers ? customers.length : ""})
      </h1>
      <div className="flex items-center space-x-1">
        <div className="modal-news">
          <Button
            ...
            onClick={() => showModal("news", "Thêm mới khách hàng")}
          >
            {" "}
            &#10010; Thêm mới
          </Button>
            ...
            <div className="flex space-x-[10px]">
              <Form.Item
                ...
                rules={[
                  ...
                  { max: 11, message: "Nhập tối đa 11 ký tự số" },
                  { type: "string", message: "Vui lòng nhập ký tự số" },
                ]}
              >
                <Input />
              </Form.Item>
