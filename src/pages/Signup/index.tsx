  ...
  return (
    <div className="bg-gray-300 flex items-center justify-center min-h-[100vh]">
      <div className="w-[700px] mx-auto bg-[white] py-[30px] shadow-lg px-[100px]">
        ...
        <h1 className="text-[22px] text-center mt-[40px] mb-[10px] font-bold">
          ĐĂNG KÝ TẠO TÀI KHOẢN
        </h1>
        <p className="text-center text-[16px] italic">
          Nhập đầy đủ thông tin để khởi tạo tài khoản của bạn
        </p>
        <div>
          <Form
            name="basic"
          ...
          >
            ...
            <Form.Item
              name="address"
              rules={[
                { required: true, message: "Vui lòng nhập chi tiết địa chỉ" },
              ]}
            >
              <Address />
              ...
              <p>
                <Checkbox onChange={onChange}>
                  <label htmlFor="">
                    ...
                    Tôi đồng ý với
                    <a
                      href="./src/assets/dieukhoansudung.pdf"
                      className=" text-[12px] text-red-600 inline-block font-bold hover:text-red-500 ml-[4px]"
                    >
                      Điều khoản sử dụng{" "}
                    </a>
                  </label>
